...
/**
 * Default file path of jQuery.
 * @see http://jquery.com/
 * @const
 * @type {string}
 */
BootstrapDocumentPublisher.JQUERY_PATH = 'http://code.jquery.com/jquery.min.js';
...
/**
 * File path of the bootstrap CSS.  You can change a bootstrap theme by setting
 * an URL to this property (or you can also use a local file by setting the file
 * URL).
...
/**
 * File path of the bootstrap script.  You can use a local file by setting an
 * file URL to this property.
...
/**
 * File path of the bootstrap CSS.  You can use a local file by setting an file
...
/**
 * File path of the bootstrap CSS.  You can use a local file by setting an URL
 * to this property.
...
/**
 * File path of the jQuery.  You can use a local file by setting an URL to
 * this property.
 * In default, use {@link BootstrapDocumentPublisher.JQUERY_PATH}.
 * @type {string}
 */
BootstrapDocumentPublisher.jqueryPath = BootstrapDocumentPublisher.JQUERY_PATH;
...
BootstrapDocumentPublisher.prototype.createScriptDoms = function(element) {
  ...
  var jquery = new HtmlElement('script')
      .setAttribute('src', BootstrapDocumentPublisher.jqueryPath)
  ...
  jsArr.push(jquery, bootstrapJs, prettifyJs, runPrettify);
  return jsArr;
};
